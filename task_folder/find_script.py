...
with open('README.md', 'w', encoding='utf-8') as readme:
    readme.write('### Отчет проверки валидности JSON данных \n'
                 ...
                 'требуемого **integer**. Далее описывается схема параметров предложенной schema-проверки файлов, '
                 'где описано правило для данного параметра. И последней строкой **On instance** указывается какой '
                 ...
                 'параметр "None", что означает ничего. Для исправления нам требуется в требуемом поле параметра '
                 ...
                 'пуст или в нем указан один единственный параметр - **Null он же None**'
                 ' \n\n')
